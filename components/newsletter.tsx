export default function Newsletter() {
  return (
    // <section>
      ...
      //   {/* CTA box */}
      //   <div className="relative bg-violet-950 py-10 px-8 md:py-16 md:px-12" data-aos="fade-up">
      ...
      //         <h3 className="h3 text-white mb-2">Agende um Diagnóstico</h3>
      //         <p className="text-purple-200 text-lg">Agradecemos por confiar no nosso trabalho. Estamos aqui para ajudar! Se você precisa de um diagnóstico ou consultoria para seus equipamentos, ficaremos felizes em agendar um horário para você. Por favor, preencha o formulário ao lado com suas informações e detalhes sobre suas necessidades. Entraremos em contato o mais rápido possível para agendar sua consulta e fornecer a assistência necessária. Logo estaremos prestando nossos serviços com qualidade e eficiência.</p>
      //       </div>
