    ...
    <div className="flex-1 lg:flex lg:items-center lg:-mx-6" >
      <div className="text-white lg:w-1/2 lg:mx-6" data-aos="flip-up" data-aos-duration="1500" data-aos-easing="ease-in-sine">
        ...
        <p className="max-w-xl mt-6">
          Faça contato com um Especialista e tire todas as suas dúvidas.
        </p>
        ...
        <div className="mt-6 md:mt-8">
          <h3 className="text-gray-300 ">Redes Sociais</h3>
          ...
          <form className="mt-4">
            ...
            <div className="w-full mt-6">
              ...
              <textarea
                ...
                placeholder="Digite aqui sua dúvida que retornaremos o mais rápido possível."
                defaultValue={""}
              />
            </div>
