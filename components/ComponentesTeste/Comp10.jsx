...
const Comp10 = () => {
  return (
    ...
    {/* SVG Background */}
    {/* Jumbotron */}
    <div className="  w-[350px] h-[800px] ml-[34px] justify-center -mt-[740px] sm:flex sm:w-auto sm:-mt-[580px] sm:ml-0 " data-aos="zoom-in" data-aos-duration="2000">
      ...
      <div className="text-center">
        ...
        >
          <h1 className="mt-2 mb-12 text-4xl font-bold tracking-tight md:text-6xl xl:text-7xl" data-aos="zoom-in" data-aos-duration="2500">
            Criação de Sites Profissionais <br />
            <span className="text-blue-400">para o seu Negócio</span>
          </h1>
          <a
            className="mb-2 inline-block rounded bg-[#25D366] px-12 pt-4 pb-3.5 text-sm font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] md:mr-2 md:mb-0"
            data-te-ripple-init=""
          ...
          <a
            className="inline-block rounded bg-[#68686832] px-12 pt-4 pb-3.5 text-sm font-medium uppercase leading-normal text-primary transition duration-150 ease-in-out hover:bg-neutral-500 hover:bg-opacity-10 hover:text-primary-600 focus:text-primary-600 focus:outline-none focus:ring-0 active:text-primary-700 dark:hover:bg-gray-500 dark:hover:bg-opacity-40"
            data-te-ripple-init=""
            data-te-ripple-color="light"
            href="#!"
            role="button"
